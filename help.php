...
<html>
	...
	<div  id = "registration_pop_up" class="popup_main_div">
		...
		<div class="help">
			...
			<h1 style="text-align:center;"class="post_header">Here will be some help and tips for using this website
			</h1>
		</div>
	</body>
...
<a href="https://github.com/md-abu-shahan" target="_blank" style="border:1px solid mediumseagreen; border-radius: 5px; padding:5px;"><i class="fa fa-github" style="color:mediumseagreen;"></i></a>
		...
		<h3 class="footer_links"><a href="help.php" >Help</a><a href="help.php" >Quick Menu</a><a href="Categories.php" >Categories</a>
