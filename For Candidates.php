...
<html>
	...
	<body>
		...
		<div class="canmain">
			<div class="can1">
				<img src="images/images.jfif" height="290px" width="250px" border="1px solid black">
			</div>
...
<a href="https://github.com/md-abu-shahan" target="_blank" style="border:1px solid mediumseagreen; border-radius: 5px; padding:5px;"><i class="fa fa-github" style="color:mediumseagreen;"></i></a>
		...
		<h3 class="footer_links"><a href="help.php" >Help</a><a href="For Candidates.php" >Quick Menu</a><a href="Categories.php" >Categories</a>
